...
def get_args():
    ...
    parser.add_argument(
        "--conv-frontend",
        type=str,
        default="models/sherpa-onnx-qwen3-asr-0.6B-int8-2026-03-25/conv_frontend.onnx",
        required=False,
    ...
    parser.add_argument(
        "--encoder",
        type=str,
        default="models/sherpa-onnx-qwen3-asr-0.6B-int8-2026-03-25/encoder.int8.onnx",
        required=False,
    ...
    parser.add_argument(
        "--decoder",
        type=str,
        default="models/sherpa-onnx-qwen3-asr-0.6B-int8-2026-03-25/decoder.int8.onnx",
        required=False,
    ...
    parser.add_argument(
        "--tokenizer",
        type=str,
        default="models/sherpa-onnx-qwen3-asr-0.6B-int8-2026-03-25/tokenizer",
        required=False,
    ...
    parser.add_argument(
        "--debug",
        action="store_true",#表示这是一个开关参数（flag），不需要传值，只要写 --debug，就自动变成 True；不写就是 False
    ...
    parser.add_argument(
        "sound_files",
        type=str,
        nargs="*",# +接收 1 个 或 多个 参数. * 可以0或者多个参数
        default=["L:/voice/VoxCPM/workspace/飘飘欲仙1188狼太郎www.xitxt.net/split_。_n_250.wav"],
